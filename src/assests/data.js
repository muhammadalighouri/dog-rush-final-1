...
function name() {
    return (
        <a href='https://DogeRush.io/Audit'>
            https://DogeRush.io/Audit
        </a>
    )
}
...
export const FAQ = [
    ...
    },
    {
        ...
        ans: [
            `Yes, Doge Rush is audited by Solid Proof. Solid Proof is a German-based blockchain auditing company, has specialized in protecting DeFi market participants with its transformation security solution.

You can view our smart contract audit here: https://DogeRush.io/Audit`,
        ],
    },
    {
