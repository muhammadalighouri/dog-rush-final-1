...
contract PriceContract {
    ...
    address private priceAddress = 0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e; // Goerli Testnet
...
contract TokenSale is Ownable, PriceContract {
    ...
    // Token token = Token(0x2d6e9d6b362354a5Ca7b03581Aa2aAc81bb530Db); // Token Mainnet;
    Token token = Token(0xb7a766bd51BD8e3cD1De2380de7ddDd460E0D4A7); // Token Goerli;
    // Token usdt = Token(0xdAC17F958D2ee523a2206206994597C13D831ec7); // USDT Mainnet
    Token usdt = Token(0x22Aef93c420011CcEc4DB8dc3034C3Dd445DE613); // USDT Goerli
    ...
    function calculateTokenAmount(uint256 amount)
        ...
        returns (uint256)
    {
        uint256 tokens = SafeMath.mul(amount, price);
        return tokens;
    }
    ...
    function investments(address add)
        external
        view
        returns (
            uint256,
